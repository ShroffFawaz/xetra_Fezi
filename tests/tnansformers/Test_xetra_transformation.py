...
class TestXetraETLMethod(unittest.TestCase):
    def setUp(self):
        ...
        data_report = [
        ['AT0000A0E9W5', '2021-04-17', 20.21, 21.19, 20.58, 18.21, 1088, -14.39],
        ['AT0000A0E9W5', '2021-04-18', 20.58, 21.14, 21.14, 18.89, 10286, 5.47],
        ['AT0000A0E9W5', '2021-04-19', 23.58, 22.21, 25.01, 22.21, 3586, 22.37],
