...
class TestXetraETLMethod(unittest.TestCase):
    def setUp(self):
        ...
        data=[
            ...
            ['AT0000A0E9W5', 'SANT', '2021-04-17', '14:00', 18.27, 21.19, 18.39, 20.58, 455],
        ...
        data_report = [
            ['AT0000A0E9W5', '2021-04-17', 20.21, 18.27, 20.58, 18.21, 1088, -14.39],
            ['AT0000A0E9W5', '2021-04-18', 20.58, 19.27, 21.14, 18.89, 10286, 5.47],
            ['AT0000A0E9W5', '2021-04-19', 23.58, 23.58, 25.01, 22.21, 3586, 22.37],
        ]
